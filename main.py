...
class Human:
    ...
    def live(self, day):
        ...
        if self.home is None:
            print("Settled in the {self.home}")
            self.get_home()
        if self.car is None:
            self.get_car()
...
class House:
    def __init__(self, house_list):
        self.home = random.choice(list(house_list))
        self.pretty = house_list[self.home]["pretty"]
        self.gladness_less_2 = house_list[self.home]["gladness_less"]
        self.mess = 0
        self.food = 0
house_list_2 = {
    "Old cheap house":
    {"pretty":0, "gladness_less": 20},
    "Old normal house":
    {"pretty":10, "gladness_less": 10},
    "New normal house":
    {"pretty":20, "gladness_less": 5},
    "New large house":
    {"pretty":30, "gladness_less": 1}
    }
job_list = {
 "Java developer":
